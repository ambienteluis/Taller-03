...
map.getView().fit([-8948970.402426, -886477.402625, -8654065.352306, -701565.836173], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Proyecto Cajamarca</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (21 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Trabajo de Visor Web ';
            }
